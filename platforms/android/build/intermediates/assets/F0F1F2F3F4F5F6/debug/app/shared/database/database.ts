...
export class Database {
    ...
    public editEvent(key: string, title: string, description: string, priority: number, startTime: Date, endTime: Date) {
    ...
    public newEvent(title: string, description: string, priority: number, startTime: Date, endTime: Date) {
